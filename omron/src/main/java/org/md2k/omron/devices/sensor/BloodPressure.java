...
public class BloodPressure extends Sensor {
    ...
    ArrayList<HashMap<String, String>> createDataDescriptors() {
        ...
        dataDescriptors.add(createDataDescriptor("Systolic Blood Pressure",25, 280, "mmHg"));
        dataDescriptors.add(createDataDescriptor("Diastolic Blood Pressure", 0, 255, "mmHg"));
        dataDescriptors.add(createDataDescriptor("Mean Arterial Pressure", 8, 262, "mmHg"));
